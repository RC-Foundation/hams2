/*
  # Fix Whistleblowing Platform Database Schema - Final
  
  This migration addresses all schema conflicts and permission issues.
  
  Key fixes:
  1. Unified schema approach (using api schema consistently)
  2. Fixed PGP key format
  3. Proper policy management
  4. Correct data types (bigint for file_size)
...
-- Ensure the api schema is in the search path
