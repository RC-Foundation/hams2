/*
  # Secure Whistleblowing Platform Database Schema
...
DROP POLICY IF EXISTS "Allow anonymous report submission" ON reports;
DROP POLICY IF EXISTS "Allow anonymous report verification by reference_id" ON reports;
DROP POLICY IF EXISTS "Allow anonymous file upload" ON report_files;
DROP POLICY IF EXISTS "Allow anonymous file access" ON report_files;
DROP POLICY IF EXISTS "Allow anonymous update viewing" ON report_updates;
DROP POLICY IF EXISTS "Allow anonymous users to insert report updates" ON report_updates;
DROP POLICY IF EXISTS "Allow anonymous settings read" ON platform_settings;
